...
One reason for this may be that the concept of the marginal likelihood is a tricky concept to grasp (for a better understanding of the marginal likelihood, see [marginal likelhood](#)). However, the *law of total probability* give the marginal likelihood as follows:
